  ...
  return (
    <div className="space-y-6">
      ...
      {weather.trails && weather.trails.length > 0 && (
        ...
        >
          <div className={`flex ${isCompact ? 'flex-col gap-4' : 'items-center justify-between'} mb-6 px-2`}>
            <div className="flex items-center gap-3">
              <Mountain className="w-5 h-5 text-primary" />
              <h3 className="text-xl font-display font-bold text-white">Trail Status</h3>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {weather.trails
              .filter(t => t.name.toLowerCase().includes(trailSearch.toLowerCase()))
              .map((trail, idx) => (
